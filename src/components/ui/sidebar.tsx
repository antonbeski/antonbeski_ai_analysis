...
>(({ side = "left", className, children, ...props }, ref) => {
  ...
  return (
    <div
      ...
      data-side={side}
      className={cn(
        "group peer hidden md:block text-foreground transition-[width] duration-300 ease-in-out",
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "group-data-[state=collapsed]/sidebar-wrapper:h-auto group-data-[state=collapsed]/sidebar-wrapper:justify-center group-data-[state=collapsed]/sidebar-wrapper:p-2",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="footer"
      className={cn("mt-auto flex flex-col border-t p-2", className)}
      {...props}
    />
  )
})
